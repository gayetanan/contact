...
*/
  ...
  function lb(a) {
    for (var b = a.j.length, c = 0; c < b; ++c) {
      ...
      if (f) return (a.da = e), (a.ha = kb.test(r(d, 4))), (a.$ = 0), !0;
    }
    return (a.u = !1);
  }
  function mb(a, b) {
  ...
  function nb(a, b) {
    ...
    switch (a.ba.h.length) {
      ...
      default:
        if (a.ea) return pb(a) && (a.ea = !1), a.h.toString() + a.g.toString();
        if (0 < a.j.length) {
          b = tb(a, b);
          c = ub(a);
          if (0 < c.length) return c;
  ...
  m("intlTelInputUtilsTemp.isValidNumber", (a, b) => {
    try {
      ...
      var e = w(c, 1),
        f = R(a, e, d);
      if (null == f || ("001" != d && e != bb(a, d))) var g = !1;
      else {
        var h = Q(c);
        g = -1 != $a(h, f);
      }
